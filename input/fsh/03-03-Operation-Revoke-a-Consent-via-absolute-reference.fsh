Instance: 03-03-Operation-Revoke-a-Consent-via-absolute-reference
...
* id = "03-03-Operation-Revoke-a-Consent-via-absolute-reference"
* meta.profile = "http://touchstone.aegis.net/touchstone/fhir/testing/StructureDefinition/testscript"
* url = "http://hl7.org/fhir/us/consent-management-tg/TestScript/03-03-Operation-Revoke-a-Consent-via-absolute-reference"
* version = "Test release 1.0, IG(s) under test: HL7 FAST Consent CURRENT"
* name = "Test_03_Operation_Revoke_a_Consent_via_absolute_reference"
* title = "03 Operations - All SUT | 03 Operation: Revoke a Consent via absolute reference"
* status = #active
* date = "2026-09-15"
...
referencing the Consent via an absolute reference.
...
* test[=].action[+].assert.warningOnly = false
* test[=].action[=].assert.description = "Confirm the Consent uses an absolute reference."
* test[=].action[=].assert.expression = "Parameters.parameter.where(name='consent').value.ofType(Reference).reference.startsWith('http')"
...
* test[=].action[=].assert.description = "Save the absolute reference from the request so we can read it in the next step and check its status.
...
* test[=].description = "Touchstone reads a Consent resource at Consent Admin Service. Read the revoked Consent using the absolute reference we saved from
...
* test[=].action[=].operation.url = "${ConsentReference}"
* test[=].action[+].assert.warningOnly = false
* test[=].action[=].assert.extension[+].url = "http://touchstone.aegis.net/touchstone/fhir/testing/StructureDefinition/testscript-assert-stopTestOnFail"
* test[=].action[=].assert.extension[=].valueBoolean = false
