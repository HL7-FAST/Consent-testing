Instance: 00-01-Obtain-server-CapabilityStatement
...
* id = "00-01-Obtain-server-CapabilityStatement"
* meta.profile = "http://touchstone.aegis.net/touchstone/fhir/testing/StructureDefinition/testscript"
* url = "http://hl7.org/fhir/us/consent-management-tg/TestScript/00-01-Obtain-server-CapabilityStatement"
...
This scenario is generic and can be used with any FHIR format.
