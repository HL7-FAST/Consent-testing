Instance: 01-02-Search-for-a-Consent
...
* id = "01-02-Search-for-a-Consent"
* meta.profile = "http://touchstone.aegis.net/touchstone/fhir/testing/StructureDefinition/testscript"
* url = "http://hl7.org/fhir/us/consent-management-tg/TestScript/01-02-Search-for-a-Consent"
...
* description = "Test a client and server to verify support for the Consent search interaction
and the return of at least one valid Consent resource conforming to the FASTConsent profile.
...
See http://qafhir4.dev.aegis.net/ig/fhir-consent-management-tg/en/rtm_test_cases.html#2search-for-a-consent
...
* test[+].name = "Step_001_Consent_search"
* test[=].description = "Consent Client searches for Consent resources at Consent Admin Service."
...
* test[=].action[=].assert.extension[+].url = "http://touchstone.aegis.net/touchstone/fhir/testing/StructureDefinition/testscript-assert-stopTestOnFail"
* test[=].action[=].assert.extension[=].valueBoolean = false
* test[=].action[=].assert.description = "Confirm that at least one Consent resource in the response declares the FASTConsent profile."
* test[=].action[=].assert.expression = "Bundle.entry.select(resource as Consent).where('http://hl7.org/fhir/us/consent-management/StructureDefinition/FASTConsent' in meta.profile).exists()"
* test[=].action[=].assert.sourceId = "dest-1-FHIRSearch-1-response"
* test[=].action[=].assert.operator = #equals
* test[=].action[=].assert.value = "true"
* test[=].action[=].assert.direction = #response