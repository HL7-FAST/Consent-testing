Instance: 00-02-Obtain-server-CapabilityStatement-JSON
...
* id = "00-02-Obtain-server-CapabilityStatement-JSON"
* meta.profile = "http://touchstone.aegis.net/touchstone/fhir/testing/StructureDefinition/testscript"
* url = "http://hl7.org/fhir/us/consent-management-tg/TestScript/00-02-Obtain-server-CapabilityStatement-JSON"
...
supporting the FAST Consent Management IG Version: CI, using JSON syntax.
...
* test[=].action[=].operation.requestHeader[=].value = "application/fhir+json"
...
* test[=].action[=].assert.direction = #response
* test[=].action[+].assert.warningOnly = false
* test[=].action[=].assert.description = "Confirm that the response format is the FHIR JSON format."
* test[=].action[=].assert.direction = #response
